...
| `benchmark_registry_missing` | `python3 scripts/orchestration/mlgg.py benchmark-suite --profile release --registry-file <path>` | Restore or re-point to valid registry file (`references/benchmark-registry.json`). / 修复或回指到有效 registry 文件 | `python3 scripts/orchestration/mlgg.py benchmark-suite --profile release --registry-file references/benchmark-registry.json --repeat 1` |
| `benchmark_registry_mismatch` | `python3 scripts/orchestration/mlgg.py benchmark-suite --profile release --registry-file references/benchmark-registry.json --repeat 1` | Re-sync registry fingerprints with frozen benchmark data; do not bypass hash checks. / 同步 registry 指纹与冻结数据，禁止绕过 hash 校验 | `python3 scripts/orchestration/mlgg.py benchmark-suite --profile release --registry-file references/benchmark-registry.json --repeat 1` |

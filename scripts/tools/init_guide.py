...
CHECKLIST_MD = textwrap.dedent("""\
    # MLGG 医学二分类预测检查清单 | Medical Binary Classification Checklist

    > 基于 ML Leakage Guard 33 道门控标准，TRIPOD+AI 2024 / PROBAST+AI 2025 合规。
...
CLAUDE_MD_TEMPLATE = textwrap.dedent("""\
    ...
    > 本文件由 ML Leakage Guard 生成，指导 AI 按照发布级标准协助医学二分类预测分析。
    > Generated by ML Leakage Guard. Instructs AI to follow publication-grade standards.
...
def write_rules_json(output_dir: Path) -> Path:
    ...
    payload = {
        ...
        "generator": "ml-leakage-guard/init_guide",

...
# Statistical comparison tests live in _diagnostics.py (pure functions on
# numpy arrays — no shared state). Re-exported here so existing callers
# (tests via tse._delong_test, _phase78_eval_diagnostics) work unchanged.
from _diagnostics import (  # noqa: E402
    _delong_test,
    _integrated_discrimination_improvement,
    _mcnemar_test,
    _net_reclassification_improvement,
)

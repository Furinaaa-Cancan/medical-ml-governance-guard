...
def parse_args() -> argparse.Namespace:
    ...
    # Gates that may be auto-skipped (e.g., CV-only mode without test split)
    # use default="" so publication_gate can run with partial evidence.
    parser.add_argument("--split-protocol-report", default="", help="Path to split protocol gate report JSON.")
    parser.add_argument("--covariate-shift-report", default="", help="Path to covariate-shift gate report JSON.")
    parser.add_argument("--definition-report", default="", help="Path to definition-variable guard report JSON.")
    parser.add_argument("--lineage-report", default="", help="Path to lineage gate report JSON.")
    parser.add_argument("--imbalance-report", default="", help="Path to imbalance policy gate report JSON.")
    parser.add_argument("--missingness-report", default="", help="Path to missingness policy gate report JSON.")
    parser.add_argument("--tuning-report", default="", help="Path to tuning leakage gate report JSON.")
    ...
    parser.add_argument("--clinical-metrics-report", default="", help="Path to clinical metrics gate report JSON.")
    parser.add_argument("--prediction-replay-report", default="", help="Path to prediction replay gate report JSON.")
    parser.add_argument("--distribution-generalization-report", default="", help="Path to distribution generalization gate report JSON.")
    parser.add_argument("--generalization-gap-report", default="", help="Path to generalization gap gate report JSON.")
    parser.add_argument("--robustness-report", default="", help="Path to robustness gate report JSON.")
    parser.add_argument("--seed-stability-report", default="", help="Path to seed stability gate report JSON.")
    ...
    parser.add_argument("--evaluation-quality-report", default="", help="Path to evaluation quality gate report JSON.")
    parser.add_argument("--permutation-report", default="", help="Path to permutation gate report JSON.")
    parser.add_argument("--fairness-equity-report", default="", help="Path to fairness & equity gate report JSON.")
    parser.add_argument("--sample-size-report", default="", help="Path to sample size gate report JSON.")

...
def parse_args() -> argparse.Namespace:
    ...
    # All gate reports use default="" so self_critique_gate can run with
    # partial evidence (e.g., CV-only mode auto-skips test-dependent gates).
    parser.add_argument("--leakage-report", default="", help="Path to leakage report JSON.")
    parser.add_argument("--split-protocol-report", default="", help="Path to split protocol report JSON.")
    parser.add_argument("--covariate-shift-report", default="", help="Path to covariate-shift report JSON.")
    parser.add_argument("--definition-report", default="", help="Path to definition guard report JSON.")
    parser.add_argument("--lineage-report", default="", help="Path to lineage gate report JSON.")
    parser.add_argument("--imbalance-report", default="", help="Path to imbalance policy report JSON.")
    parser.add_argument("--missingness-report", default="", help="Path to missingness policy report JSON.")
    parser.add_argument("--tuning-report", default="", help="Path to tuning leakage report JSON.")
    parser.add_argument("--model-selection-audit-report", default="", help="Path to model selection audit report JSON.")
    parser.add_argument("--feature-engineering-audit-report", default="", help="Path to feature engineering audit report JSON.")
    parser.add_argument("--clinical-metrics-report", default="", help="Path to clinical metrics report JSON.")
    parser.add_argument("--prediction-replay-report", default="", help="Path to prediction replay gate report JSON.")
    parser.add_argument("--distribution-generalization-report", default="", help="Path to distribution generalization report JSON.")
    parser.add_argument("--generalization-gap-report", default="", help="Path to generalization gap report JSON.")
    parser.add_argument("--robustness-report", default="", help="Path to robustness report JSON.")
    parser.add_argument("--seed-stability-report", default="", help="Path to seed stability report JSON.")
    parser.add_argument("--external-validation-report", default="", help="Path to external validation gate report JSON.")
    parser.add_argument("--calibration-dca-report", default="", help="Path to calibration/DCA gate report JSON.")
    parser.add_argument("--ci-matrix-report", default="", help="Path to CI matrix gate report JSON.")
    parser.add_argument("--metric-report", default="", help="Path to metric consistency report JSON.")
    parser.add_argument("--evaluation-quality-report", default="", help="Path to evaluation quality report JSON.")
    parser.add_argument("--permutation-report", default="", help="Path to permutation report JSON.")
    parser.add_argument("--publication-report", default="", help="Path to publication gate report JSON.")

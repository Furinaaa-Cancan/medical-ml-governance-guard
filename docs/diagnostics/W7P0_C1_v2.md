# RAG eval report -- 2026-05-16T22:03:41Z
...
|----|-------:|-----:|------:|--------:|--------:|
| `leakage_discharge_icd` | 5 | 0.485 | 1 | 0.400 | 9963 |
| `evaluation_improper_f1_primary` | 5 | 0.726 | 1 | 0.800 | 30 |
| `no_external_validation_single_center` | 5 | 0.797 | 1 | 0.600 | 26 |
| `cohort_definition_selection_bias` | 5 | 0.658 | 1 | 0.800 | 28 |
| `calibration_plot_missing_no_dca` | 5 | 0.661 | 1 | 0.800 | 27 |
...
| `clinical_threshold_no_sensitivity_specificity` | 5 | 0.669 | 1 | 0.400 | 27 |
| `definition_variable_outcome_in_feature` | 5 | 0.644 | 1 | 0.600 | 26 |
| `imbalance_smote_without_justification` | 5 | 0.737 | 1 | 1.000 | 24 |
| `feature_selection_data_leakage` | 5 | 0.642 | 1 | 0.200 | 32 |
...
| `sample_size_epv_violated` | 5 | 0.751 | 1 | 0.800 | 26 |

# RAG eval report -- 2026-05-16T21:55:30Z
...
|----|-------:|-----:|------:|--------:|--------:|
| `leakage_discharge_icd` | 5 | 0.485 | 1 | 0.400 | 12929 |
| `evaluation_improper_f1_primary` | 0 | - | - | - | 0 |
| `no_external_validation_single_center` | 5 | 0.692 | 1 | 0.600 | 44 |
| `cohort_definition_selection_bias` | 0 | - | - | - | 0 |
| `calibration_plot_missing_no_dca` | 5 | 0.628 | 1 | 0.800 | 62 |
| `model_selection_cherry_picked_seed` | 5 | 0.643 | 1 | 0.600 | 52 |
...
| `imbalance_smote_without_justification` | 5 | 0.692 | 1 | 0.800 | 42 |

# RAG eval report -- 2026-05-16T21:59:32Z
...
|----|-------:|-----:|------:|--------:|--------:|
| `leakage_discharge_icd` | 5 | 0.485 | 1 | 0.400 | 10500 |
| `evaluation_improper_f1_primary` | 0 | - | - | - | 0 |
| `no_external_validation_single_center` | 5 | 0.692 | 1 | 0.600 | 28 |
| `cohort_definition_selection_bias` | 0 | - | - | - | 0 |
| `calibration_plot_missing_no_dca` | 5 | 0.628 | 1 | 0.800 | 24 |
| `model_selection_cherry_picked_seed` | 5 | 0.643 | 1 | 0.600 | 26 |
...
| `imbalance_smote_without_justification` | 5 | 0.692 | 1 | 0.800 | 26 |
| `feature_selection_data_leakage` | 0 | - | - | - | 0 |
| `tuning_hyperparameter_on_test_set` | 5 | 0.602 | 1 | 0.800 | 14 |
| `ci_missing_or_suspiciously_narrow` | 5 | 0.679 | 1 | 0.400 | 13 |
...
| `weak_offdomain_music_query` | 0 | - | - | - | 15 |
| `weak_offdomain_sailing_query` | 0 | - | - | - | 13 |

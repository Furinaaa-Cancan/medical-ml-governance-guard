# RAG eval report -- 2026-05-16T21:56:00Z
...
|----|-------:|-----:|------:|--------:|--------:|
| `leakage_discharge_icd` | 5 | 0.485 | 1 | 0.400 | 11284 |
| `evaluation_improper_f1_primary` | 0 | - | - | - | 0 |
| `no_external_validation_single_center` | 5 | 0.797 | 1 | 0.600 | 49 |
| `cohort_definition_selection_bias` | 0 | - | - | - | 0 |
| `calibration_plot_missing_no_dca` | 5 | 0.661 | 1 | 0.800 | 37 |
| `model_selection_cherry_picked_seed` | 5 | 0.648 | 1 | 0.600 | 35 |
...
| `imbalance_smote_without_justification` | 5 | 0.737 | 1 | 1.000 | 38 |
| `feature_selection_data_leakage` | 0 | - | - | - | 0 |
| `tuning_hyperparameter_on_test_set` | 5 | 0.602 | 1 | 0.800 | 14 |
| `ci_missing_or_suspiciously_narrow` | 5 | 0.679 | 1 | 0.200 | 16 |
| `fairness_subgroup_performance_gap` | 5 | 0.683 | 1 | 0.400 | 16 |
...
| `weak_offdomain_sailing_query` | 0 | - | - | - | 15 |
| `weak_offdomain_woodworking_query` | 0 | - | - | - | 11 |

"""Smoke test for the committed post-Wave-7 baseline snapshot."""
import json
from pathlib import Path

REPO_ROOT = Path(__file__).resolve().parents[1]
JSON = REPO_ROOT / "references/retrieval_eval/post_wave7_baseline_hybrid.json"
MD = REPO_ROOT / "references/retrieval_eval/post_wave7_baseline_hybrid.md"
